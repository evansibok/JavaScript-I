...
console.log(`The last car in the inventory is of make '${lastCar.car_make}' and of model '${lastCar.car_model}'`);

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console
let carModels = [];
let carModelsSorted = [];
console.log(`Sorted car models in alphabetical order: ${carModelsSorted}`);
...
let oldCars = [];
oldCars = inventory.sort((a, b) => {
  if (a.car_year < 2000) {
    return 1;
  } else if (a.car_year > 2000) {
    return -1; 
  } else {
    return 0;
  }
